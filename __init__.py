...
from .nodes_video import WS_KlingVideo, WS_SeedanceVideo, WS_LoadVideoURL
...
print("[WaveSpeed API] Nodes loaded: NanaBanana, Seedream, Kling, Seedance, LoadVideoURL")
